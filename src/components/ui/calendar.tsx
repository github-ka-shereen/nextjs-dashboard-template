...
const calenderToDate = new Date();
calenderToDate.setFullYear(calenderToDate.getFullYear() + 5);

const calenderFromDate = new Date();
calenderFromDate.setFullYear(calenderFromDate.getFullYear() - 150);
...
function Calendar({
  ...
  return (
    <DayPicker
      weekStartsOn={1}
      fixedWeeks
      fromDate={calenderFromDate}
      toDate={calenderToDate}
      captionLayout='dropdown-buttons'
      showOutsideDays={showOutsideDays}
      className={cn('p-3 dark:bg-black bg-white rounded-sm', className)}
      classNames={{
